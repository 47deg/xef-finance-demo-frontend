...
export let icons = new Map<string, JSX.Element>([
...
export let cat1Titles = new Map<string, string>([
...
export function getIcon(s: string): JSX.Element {
    ...
    let icon = maybeIcon ??= <myIcons.AttachMoneyOutlined/>;
        ...
        <Card key={`cat-${props.category.name}`} className={styles.card}>
            <CardHeader className={styles.cardHeader}
                        ...
                        sx={{
                            ...
                            '& .MuiCardHeader-title': {fontSize: 12, fontWeight:500, color:'#999'},
                            '& .MuiCardHeader-subheader': {fontSize: 13, fontWeight:700, color:'#666'},
                        }}
