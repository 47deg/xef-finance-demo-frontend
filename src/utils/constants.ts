...
export function getTheme(): Theme {
  const defaultTheme: Theme = {
    name: 'default',
    logofilename: 'logoXebia.png',
    colorOne: '#691d5d',
    colorTwo: '#691d5d',
    locale: 'en-US',
    currency: 'USD',
  }
  const capital1Theme: Theme = {
    name: 'capone',
    logofilename: 'CapitalOneLogo.png',
    colorOne: '#004879',
    colorTwo: '#D22E1E',
    locale: 'en-US',
    currency: 'USD',
  }
  const irelandTheme: Theme = {
    name: 'ireland',
    logofilename: 'logo_bank_ireland.png',
    colorOne: '#0703f5',
    colorTwo: '#888888',
    locale: 'en-GB',
    currency: 'GBP',
  ...
  const chosenTheme: string = localStorage.getItem('theme') || ''
  const maybeTheme: Theme = themes.get(chosenTheme)
